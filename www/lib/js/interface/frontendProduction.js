...
var frontendProduction = function () {
    ...
    this.getRemainingSpace = function (successCallback, errorCallback) {
        return this.backend.getRemainingSpace();
    }
    ...
    this.uploadFile = function (obj, successCallback, errorCallback, file) {
        ...
        if (obj && obj.targetPath) {
            obj.targetPath = encodeURI(obj.targetPath);
            this.backend.uploadFile(obj, successCallback, errorCallback, file);
        } else {
            errorCallback();
        }
    ...
    this.downloadFile = function (obj, successCallback, errorCallback, targetFile) {
        ...
        if (checkDirName) {
            this.backend.downloadFile(obj, successCallback, errorCallback, targetFile);
        } else {
            errorCallback("DOWNLOADFOLDER");
        }

        return;
    }
    //TODO
    this.getPublicLink = function (obj, successCallback, errorCallback) {
        this.debug("Frontend-Funktion getPublicLink");
        return true;
    }
